import "dotenv/config.js"; // importamos el modulo dotenv para poder usar las variables de entorno
...
const port = process.env.SERVER_PORT; // sintaxis para acceder a las variables de entorno
const ready = async () => {
